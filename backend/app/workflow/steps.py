...
WORKFLOW_STEPS = [
    ...
    {"id": "create_branch", "label": "Create Branch", "icon": "branch"},
    {"id": "approval_deploy_staging", "label": "Approve Deploy Staging", "icon": "user"},
    {"id": "deploy_staging", "label": "Deploy Staging", "icon": "rocket"},
    {"id": "approval_smoke_staging", "label": "Approve Smoke Test (Staging)", "icon": "user"},
    {"id": "smoke_staging", "label": "Smoke Test (Staging)", "icon": "check"},
    {"id": "approval_staging", "label": "Approve Staging Release", "icon": "user"},
